...
interface TeacherLessonExamsTabProps {
    lessonId: string;
}

export default function TeacherLessonExamsTab({ lessonId }: TeacherLessonExamsTabProps) {
    ...
    const handleSuccess = () => {
        ...
        toast({
            status: 'success',
            title: 'تم بنجاح',
            description: 'تم تحديث قائمة الامتحانات',
        });
    };
