...
export default function CourseLessonsTab({ courseId }: CourseLessonsTabProps) {
    ...
    const fetchLessons = async () => {
        try {
            setLoading(true);
            const response = await coursesService.getCourseLessons(courseId, {
                page,
                limit: 30,
