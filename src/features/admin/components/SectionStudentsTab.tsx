...
export default function SectionStudentsTab({ sectionId }: SectionStudentsTabProps) {
    ...
    const fetchStudents = async () => {
        try {
            setLoading(true);
            const response = await sectionsService.getSectionStudents(sectionId, {
                page,
                limit: 30,
                    ...
                    >
                        <Stack flex={1}>
                            ...
                            <Text fontSize="sm" color="gray.600">
                                قائمة جميع الطلاب المشتركين في القسم
                            </Text>
                            {!loading && (
