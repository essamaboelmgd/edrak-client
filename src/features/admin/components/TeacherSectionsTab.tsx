...
interface TeacherSectionsTabProps {
    teacherId: string;
}

export default function TeacherSectionsTab({ teacherId }: TeacherSectionsTabProps) {
    ...
    const fetchSections = async () => {
        try {
            setLoading(true);
            const response = await teachersService.getTeacherSections(teacherId);
