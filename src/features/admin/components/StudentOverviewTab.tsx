...
export default function StudentOverviewTab({ studentId }: StudentOverviewTabProps) {
    ...
    const fetchOverview = async () => {
        try {
            setLoading(true);
            const response = await studentsService.getStudentOverview(studentId);
                        ...
                        <HStack justify="space-between">
                            <VStack align="start" spacing={0}>
                                ...
                                <Text fontSize="2xl" fontWeight="bold" color="orange.600">
                                    EGP {overview.totalSpent?.toLocaleString() || 0}
                                </Text>
                            </VStack>
                        ...
                        <HStack justify="space-between">
                            <VStack align="start" spacing={0}>
                                ...
                                <Text fontSize="2xl" fontWeight="bold" color="cyan.600">
                                    EGP {overview.walletAmount?.toLocaleString() || 0}
                                </Text>
                            </VStack>
