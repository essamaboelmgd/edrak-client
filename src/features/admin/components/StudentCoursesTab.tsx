...
export default function StudentCoursesTab({ studentId }: StudentCoursesTabProps) {
                        ...
                        <CardBody>
                            <VStack align="stretch" spacing={3}>
                                ...
                                <HStack justify="space-between">
                                    ...
                                    <Text fontSize="xs" color="gray.500">
                                        {new Date(course.subscriptionDate).toLocaleDateString('ar-EG')}
                                    </Text>
                                </HStack>
                                ...
                                <HStack justify="space-between" fontSize="xs" color="gray.500">
                                    {course.teacher && (
                                        <HStack spacing={1}>
                                            <Icon icon="solar:user-bold-duotone" width="14" height="14" />
