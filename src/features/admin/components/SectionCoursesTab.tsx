...
export default function SectionCoursesTab({ sectionId }: SectionCoursesTabProps) {
    ...
    const fetchCourses = async () => {
        try {
            setLoading(true);
            const response = await sectionsService.getSectionCourses(sectionId, {
                page,
                limit: 30,
    ...
    const inactiveCourses = courses.filter((c) => c.status === 'inactive' || c.status === 'draft').length;
                ...
                <Stack p={5} spacing={4}>
                    ...
                    {!loading && (
                        <HStack spacing={3} flexWrap="wrap">
                            <HStack
                                spacing={2}
                                bg={statusFilter === 'all' ? 'blue.100' : 'blue.50'}
                                px={4}
                                py={2.5}
                                borderRadius="lg"
                                border="1px"
                            ...
                            <HStack
                                spacing={2}
                                bg={statusFilter === 'active' ? 'green.100' : 'green.50'}
                                px={4}
                                py={2.5}
                                borderRadius="lg"
                                border="1px"
