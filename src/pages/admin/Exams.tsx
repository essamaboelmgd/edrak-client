                  ...
                  {loading || isFetching ? (
                    ...
                    <Tr>
                      <Td colSpan={12} textAlign="center" py={8}>
                        <VStack spacing={2}>
                          <Icon icon="solar:document-text-bold-duotone" width="48" height="48" color="gray.300" />
                    ...
                    exams.map((exam, idx) => (
                      <Tr key={exam._id}>
                        ...
                        <Td fontSize="sm" fontWeight="medium">{exam.totalPoints || 0}</Td>
                        <Td fontSize="sm" fontWeight="medium">{exam.questionCount || 0}</Td>
                        <Td>
                        ...
                        <Td fontSize="sm" fontWeight="medium">{exam.stats.totalAttempts || 0}</Td>
