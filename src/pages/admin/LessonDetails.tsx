...
import LessonHomeworksTab from '@/features/admin/components/LessonHomeworksTab';
import LessonExamsTab from '@/features/admin/components/LessonExamsTab';
import LessonQuestionBankTab from '@/features/admin/components/LessonQuestionBankTab';
            ...
            <Card borderRadius="xl" border="1px" borderColor="gray.200" boxShadow="lg">
                ...
                >
                    ...
                    <TabPanels mt={4}>
                        ...
                        {/* Homeworks Tab */}
                        <TabPanel px={0}>
                            <LessonHomeworksTab lessonId={id!} />
                        </TabPanel>

                        {/* Exams Tab */}
                        <TabPanel px={0}>
                            <LessonExamsTab lessonId={id!} />
                        </TabPanel>

                        {/* Question Bank Tab */}
                        <TabPanel px={0}>
                            <LessonQuestionBankTab lessonId={id!} />
                        </TabPanel>
